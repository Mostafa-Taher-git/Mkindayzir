...
- Name: agent.spec.ts >> it agent >> TC-AGT-03 HR ticket detail returns 404 (no data leak)
- Location: Test Case/samples/agent.spec.ts:26:7

# Error details

```
Error: login failed for hragent
