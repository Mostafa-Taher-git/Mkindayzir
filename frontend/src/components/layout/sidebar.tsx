...
const navItems = [
  ...
  { href: ROUTES.STORMS, label: "Storms", icon: StormSidebarIcon },
...
function StormSidebarIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 15h10a4 4 0 0 0 0-8 7 7 0 0 0-12 4.8" /><path d="M8 19a5 5 0 0 0 10 0 5 5 0 0 0-5-5h-2" /><path d="M13 15l-3 4 3 4" /></svg>
  );
}
