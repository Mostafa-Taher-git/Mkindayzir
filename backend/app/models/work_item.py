...
class WorkItem(Base):
    ...
    links: Mapped[list["WorkItemLink"]] = relationship(back_populates="source", cascade="all, delete-orphan")
    linkedBy: Mapped[list["WorkItemLink"]] = relationship(back_populates="target", cascade="all, delete-orphan")
